...
type AlipayEcoMycarParkingParkinglotinfoCreateRequest struct {
  api.IAlipayRequest
  ...
  BizContent          AlipayEcoMycarParkingParkinglotinfoCreateRequestBizContent `json:"biz_content"`
}

type AlipayEcoMycarParkingParkinglotinfoCreateRequestBizContent struct {
...
func (this *AlipayEcoMycarParkingParkinglotinfoCreateRequest) GetTerminalType() string {
  return this.TerminalType
}

func (this *AlipayEcoMycarParkingParkinglotinfoCreateRequest) GetTerminalInfo() string {
  return this.TerminalInfo
}

func (this *AlipayEcoMycarParkingParkinglotinfoCreateRequest) GetNotifyUrl() string {
  return this.NotifyUrl
}

func (this *AlipayEcoMycarParkingParkinglotinfoCreateRequest) GetReturnUrl() string {
  return this.ReturnUrl
}

func (this *AlipayEcoMycarParkingParkinglotinfoCreateRequest) GetProdCode() string {
  return this.ProdCode
}

func (this *AlipayEcoMycarParkingParkinglotinfoCreateRequest) IsNeedEncrypt() bool {
  return false
}

func (this *AlipayEcoMycarParkingParkinglotinfoCreateRequest) GetTextParams() *utils.AlipayHashMap {
