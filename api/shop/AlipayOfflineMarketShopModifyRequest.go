...
type AlipayOfflineMarketShopModifyRequest struct {
  api.IAlipayRequest
  ...
  BizContent    AlipayOfflineMarketShopModifyRequestBizContent  `json:"biz_content"`
}

type AlipayOfflineMarketShopModifyRequestBizContent struct {
...
func (this *AlipayOfflineMarketShopModifyRequest) GetApiMethodName() string {
  return "alipay.offline.market.shop.modify"
}

func (this *AlipayOfflineMarketShopModifyRequest) GetApiVersion() string {
  return "1.0"
}

func (this *AlipayOfflineMarketShopModifyRequest) GetTerminalType() string {
  return this.TerminalType
}

func (this *AlipayOfflineMarketShopModifyRequest) GetTerminalInfo() string {
  return this.TerminalInfo
}

func (this *AlipayOfflineMarketShopModifyRequest) GetNotifyUrl() string {
  return this.NotifyUrl
}

func (this *AlipayOfflineMarketShopModifyRequest) GetReturnUrl() string {
  return this.ReturnUrl
}

func (this *AlipayOfflineMarketShopModifyRequest) GetProdCode() string {
  return this.ProdCode
}

func (this *AlipayOfflineMarketShopModifyRequest) IsNeedEncrypt() bool {
  return false
}

func (this *AlipayOfflineMarketShopModifyRequest) GetTextParams() *utils.AlipayHashMap {
